    ...
    <form wire:submit="save" autocomplete="off">
        <div class="space-y-12">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base/7 font-semibold text-gray-900">Editar Produto</h2>
                <p class="text-sm/6 text-gray-600">Altere os dados para atualizar o produto.</p>
